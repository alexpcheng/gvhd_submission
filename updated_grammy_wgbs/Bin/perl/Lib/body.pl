...
{
   $tmp_file = 'tmp_' . time . '.' . rand() . '.body.pl';
...
-f:               Allow giving BEG and END as fractions of number of lines in file (for example body.pl 4 -0.2)
